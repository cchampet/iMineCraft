#ifndef _IMAC2GL3_MONSTERCUBE_HPP_
#define _IMAC2GL3_MONSTERCUBE_HPP_
...
private:
    ...
    MonsterCube(const MonsterCube& c) {
    }
    
    MonsterCube& operator =(const MonsterCube& c) {
        return *this;
    }
public:
    // Constructeur: alloue le tableau de données et construit les attributs des vertex
    MonsterCube(int type=0):
