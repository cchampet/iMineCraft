#ifndef _IMAC2GL3_NEUTRALCUBE_HPP_
#define _IMAC2GL3_NEUTRALCUBE_HPP_
...
private:
    ...
    NeutralCube(const NeutralCube& c) {
    }
    
    NeutralCube& operator =(const NeutralCube& c) {
        return *this;
    }
public:
    // Constructeur: alloue le tableau de données et construit les attributs des vertex
    NeutralCube(int type=1):
